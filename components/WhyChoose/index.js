...
function Why() {
  return (
    <div className='bg-whychoose min-h-screen text-white flex flex-col items-center text-center'>
        ...
        <div className='text-7xl w-[70%] mt-16 mb-12'>
        AI-driven solutions backed by science
        </div>
        <div className='w-[70%] text-xl text-[#8A8A8A]'>
        ...
        <div className='grid grid-cols-2 text-left gap-10 text-[18px] font-[400] text-[#FFFFFF]'>
            <div>
                {list1.map((item)=>{
                    return(
